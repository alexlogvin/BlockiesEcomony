 ...
 *
 * <p>The 1.21.11 form. Drawing is as it was in 1.21.6; what changed is the id type,
 * renamed from ResourceLocation to Identifier.
 */
public final class GuiGraphicsCompat {
    ...
    public static void drawIcon(GuiGraphics graphics, Object texture,
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, (Identifier) texture, x, y, 0.0F,
