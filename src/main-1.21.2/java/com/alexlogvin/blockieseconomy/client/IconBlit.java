 ...
 * override, so it cannot be written once for both — and rather than fork {@link CoinIcon}
 * and every other drawing class per era, the one incompatible line lives here and
 * everything above it stays shared.
 *
 * <p>This is the 1.21.2 form. The caller now names the render type rather than letting
 * the method imply it; {@code guiTextured} is the one that was implied before.
 */
