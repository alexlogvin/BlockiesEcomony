 ...
 *
 * <p>This is the 21.4 form, carried forward. The event was renamed from
 * {@code AddReloadListenerEvent}, moved under a sorted base class, and now wants an id for
 * the listener so that other mods can declare an ordering against it.
 */
final class ReloadListeners {
    ...
    private static final Identifier ID =
            Identifier.tryParse(BlockiesEconomy.MOD_ID + ":prices");
