...
/**
 * Fabric/Quilt client entry point for Minecraft 1.21.1.
 *
 * <p>Version-specific because Fabric API's HUD callback changed shape after 1.20.1: there it
 * hands over a partial tick as a float, and here a {@code DeltaTracker}.
 */
