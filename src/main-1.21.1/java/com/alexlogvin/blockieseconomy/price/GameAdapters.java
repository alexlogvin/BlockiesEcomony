...
/**
 * {@link GameAdapter} for Minecraft 1.21.1.
 *
 * <p>Differs from the 1.20.1 variant in three places: recipes are wrapped in
 * {@code RecipeHolder} since identity moved out of {@code Recipe} in 1.20.2; the
 * advancement hierarchy lives in {@code AdvancementTree}/{@code AdvancementNode} rather
 * than on the advancement; and item data is components rather than NBT.
 */
