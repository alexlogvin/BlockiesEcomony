 ...
 *
 * <p>The 1.21.6 form. Drawing moved onto render pipelines, the pose stack became a JOML
 * {@code Matrix3x2fStack} that scales in two dimensions, and a tooltip is queued for
 * the next frame rather than drawn where the call happens.
 */
public final class GuiGraphicsCompat {
    ...
    public static void drawIcon(GuiGraphics graphics, Object texture,
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, (ResourceLocation) texture, x, y, 0.0F,
                0.0F, size, size, textureSize, textureSize, textureSize, textureSize);
    }
